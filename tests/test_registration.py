...
class TestRegistration:
    def test_success_registration_six_symbols_show_login_page(self, registration):
        driver = registration
        driver.find_element(*Locators.PASSWORD).send_keys(str(random.randint(100000, 999999)))
